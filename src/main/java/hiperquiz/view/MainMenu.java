...
import hiperquiz.commands.common.ExitMenuCommand;
import hiperquiz.commands.common.LoadEntitiesCommand;
import hiperquiz.commands.quizzes.*;
import hiperquiz.commands.users.*;
...
//        });
        ...
        commands.put(MenuCommand.EXIT, new ExitMenuCommand(userService, quizService, questionService, answerService, quizResultService));
        commands.put(MenuCommand.ADD_QUIZ, new CreateQuizCommand(quizService, userService, questionService, answerService, in));
        commands.put(MenuCommand.EDIT_QUIZ, new EditQuizCommand(quizService));
        commands.put(MenuCommand.LIST_ALL_QUIZ_RESULTS, new ListAllQuizResultsCommand(quizResultService));
        commands.put(MenuCommand.LIST_ALL_QUIZZES, new ListAllQuizzesCommand(quizService));
        commands.put(MenuCommand.PLAY_QUIZ, new PlayQuizCommand(quizService, userService, answerService, quizResultService, in));
        commands.put(MenuCommand.VIEW_QUIZ, new ViewQuizCommand(quizService));
        commands.put(MenuCommand.ADD_USER, new CreateUserCommand(userService, in));
        commands.put(MenuCommand.DELETE_USER, new DeleteUserCommand());
        commands.put(MenuCommand.EDIT_USER, new EditUserCommand(userService));
        commands.put(MenuCommand.LIST_ALL_USERS, new ListAllUsersCommand(userService));
        commands.put(MenuCommand.LOGIN_USER, new LoginUserCommand(userService, in));
        commands.put(MenuCommand.LOGOUT_USER, new LogoutUserCommand(userService));
        commands.put(MenuCommand.REGISTER_USER, new RegisterUserCommand(userService, in));
        commands.put(MenuCommand.VIEW_USER, new ViewUserCommand(userService, in));
